    ...
    <header className={clsx("hero hero--primary", styles.homepage)}>
      <div className="container">
        <Heading as="h1" className={styles.homepageTitle}>
          AI Native{" "}
          <span className={styles.homepageTitleStrong}>Multimodal</span>{" "}
          Database
        </Heading>
        <p className={styles.homepageDescription}>
          InferDB, a multimodal AI inference database, is specifically designed
          for AI applications. It enables vectorization, storage, and efficient
          indexing of unstructured data, while supporting multiple query methods
          such as similarity search, full-text search, and metadata filtering.
          Compatible with Python and client access, it allows developers to
